...
ALL_MODIFICATIONS = {
    # ── RH вставные, НКТ 60,3 мм (размеры 106, 125, 150, 175) ───────────────────── 
    "RH_60": {
        "nkt": "60.3",
        ...
        "sizes": {
            "20-106": [
                ...
                {"full": "20-106 RHAM (OCT)",           "label": "RHAM (OCT)",              "desc": "Верхнее мех. (OCT)"},
                ...
                {"full": "20-106 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
            ],
            "20-125": [
                {"full": "20-125 RHAM",                 "label": "RHAM",                    "desc": "Верхнее мех. (API)"},
                {"full": "20-125 RHAM (OCT)",           "label": "RHAM (OCT)",              "desc": "Верхнее мех. (OCT)"},
                {"full": "20-125 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
                {"full": "20-125 RHBM",                 "label": "RHBM",                    "desc": "Нижнее мех."},
                {"full": "20-125 RHAC",                 "label": "RHAC",                    "desc": "Верхнее манж."},
                {"full": "20-125 RHBC",                 "label": "RHBC",                    "desc": "Нижнее манж."},
            ],
            "20-150": [
                {"full": "20-150 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
                {"full": "20-150 RHBC",                 "label": "RHBC",                    "desc": "НКТ 60,3 мм, без удлинителей"},
            ],
            "20-175": [
                {"full": "20-175 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
                {"full": "20-175 RHM-TП",               "label": "RHM-TП",                  "desc": "Узел перенесён вниз"},
            ],
        },
    },

    # ── RH вставные, НКТ 73,0 мм (размеры 106, 125, 150 и 175) ───────────────────── 
    "RH_73": {
        "nkt": "73.0",
        ...
        "sizes": {
            "25-106": [
                ...
                {"full": "25-106 RHAM-T",               "label": "RHAM-T",                  "desc": "крепл. API с увеличенным узлом крепления"},
                {"full": "25-106 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
                {"full": "25-106 RHBM",                 "label": "RHBM",                    "desc": "с увеличенным узлом крепления"},
                {"full": "25-106 RHAC",                 "label": "RHAC",                    "desc": "с увеличенным узлом крепления"},
                {"full": "25-106 RHBC",                 "label": "RHBC",                    "desc": "с увеличенным узлом крепления"},
            ],
            "25-125": [
                {"full": "25-125 RHAM (Конус)",         "label": "RHAM (Конус)",            "desc": "спец. крепл. “Конус в конус”"},
                {"full": "25-125 RHAM-T",               "label": "RHAM-T",                  "desc": "крепл. API с увеличенным узлом крепления"},
                {"full": "25-125 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
                {"full": "25-125 RHBM",                 "label": "RHBM",                    "desc": "с увеличенным узлом крепления"},
                {"full": "25-125 RHAC",                 "label": "RHAC",                    "desc": "с увеличенным узлом крепления"},
                {"full": "25-125 RHBC",                 "label": "RHBC",                    "desc": "с увеличенным узлом крепления"},
            ],
            "25-150": [
                {"full": "25-150 RHAM",                 "label": "RHAM",                    "desc": "Верхнее мех. (API)"},
                {"full": "25-150 RHAM (OCT)",           "label": "RHAM (OCT)",              "desc": "Верхнее мех. (OCT)"},
                {"full": "25-150 RHAM (Конус)",         "label": "RHAM (Конус)",            "desc": "Спец. крепл. «Конус в конус»"},
                {"full": "25-150 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
            ...
            "25-175": [
                ...
                {"full": "25-175 RHAM-П",               "label": "RHAM-П",                  "desc": "Верхнее мех. (API)"},
                {"full": "25-175 RHAM (OCT)",           "label": "RHAM (OCT)",              "desc": "Верхнее мех. (OCT)"},
                {"full": "25-175 RHAM (Конус)",         "label": "RHAM (Конус)",            "desc": "Спец. крепл. «Конус в конус»"},
                {"full": "25-175 RHM-T",                "label": "RHM-T",                   "desc": "Узел перенесён вниз"},
                {"full": "25-175 RHM-TП",               "label": "RHM-TП",                  "desc": "Узел перенесён вниз"},
                ...
                {"full": "25-175 RHTM (OCT)",           "label": "RHTM (OCT)",              "desc": "Нижн. мех. (OCT), подв. цил."},
            ],
        },
    },

    # ── RH вставные, НКТ 88,9 мм (размер 150 и 225) ────────────────────────────
    "RH_89": {
        "nkt": "88.9",
        "label": "НКТ 88,9 мм (3 1/2\")",
        "sizes": {
            "30-150": [
                {"full": "30-150 RHBM (2-ст)",          "label": "RHBM (2-ст)",             "desc": "Двухступенчатый"},
            ],
            "30-225": [
                {"full": "30-225 RHBM",                 "label": "RHBM",                    "desc": "Нижнее мех."},
                {"full": "30-225 RHBM (2-ст)",          "label": "RHBM (2-ст)",             "desc": "Двухступенчатый"},
            ],
        },
    },
    ...
    # ── TH трубные, НКТ 73,0 мм (размер 106, 125, 150, 175 и 225) ─────────────────────────────
    "TH_73": {
        "nkt": "73.0",
        "label": "НКТ 73,0 мм (2 7/8\")",
        "sizes": {
            "25-106": [
                {"full": "25-106 THM-C",                "label": "THM-C",                   "desc": "с увеличенной верхней муфтой, неизвлекаемым всасывающим клапаном увеличенного размера и сбивным винтом)"},
                {"full": "25-106 THM-СЛ",               "label": "THM-СЛ",                  "desc": "с увеличенной верхней муфтой, неизвлекаемым всасывающим клапаном увеличенного размера и сбивным винтом)"},
            ],
            "25-125": [
                {"full": "25-125 THM",                  "label": "THM",                     "desc": "с увеличенной верхней муфтой"},
                {"full": "25-125 THM-T",                "label": "THM-T",                   "desc": "с увеличенной верхней муфтой и неизвлекаемым всасывающим клапаном увеличенного размера)"},
                {"full": "25-125 THM-C",                "label": "THM-C",                   "desc": "с увеличенной верхней муфтой, неизвлекаемым всасывающим клапаном увеличенного размера и сбивным винтом)"},
                {"full": "25-125 THM-СЛ",               "label": "THM-СЛ",                  "desc": "с увеличенной верхней муфтой, неизвлекаемым всасывающим клапаном увеличенного размера и сбивным винтом)"},
            ],
            "25-150": [
                {"full": "25-150 THM-C",                "label": "THM-C",                   "desc": "с увеличенной верхней муфтой, неизвлекаемым всасывающим клапаном увеличенного размера и сбивным винтом)"},
                {"full": "25-150 THM-СЛ",               "label": "THM-СЛ",                  "desc": "с увеличенной верхней муфтой, неизвлекаемым всасывающим клапаном увеличенного размера и сбивным винтом)"},
            ],
            "25-175": [
            ...
            "25-225": [
                ...
                {"full": "25-225 THM-CП",               "label": "THM-C",                   "desc": "Клапан увел. + сбивной"},
                {"full": "25-225 THM-CПА",              "label": "THM-C",                   "desc": "Клапан увел. + сбивной"},
